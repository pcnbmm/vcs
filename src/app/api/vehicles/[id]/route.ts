  ...
  try {
    ...
    const updatedVehicle = await prisma.vc_car_master.update({
      ...
      data: {
        ...
        fleetcard_no:
          body.fleetcard_no !== undefined ? body.fleetcard_no : undefined,
        body_no: body.body_no !== undefined ? body.body_no : undefined,
        machine_no: body.machine_no !== undefined ? body.machine_no : undefined,
        cylinder_capacityp:
          body.cylinder_capacityp !== undefined
            ? body.cylinder_capacityp
            : undefined,
        horse_power:
          body.horse_power !== undefined ? body.horse_power : undefined,
        weight: body.weight !== undefined ? body.weight : undefined,
        own_div_code:
          body.own_div_code !== undefined ? body.own_div_code : undefined,
